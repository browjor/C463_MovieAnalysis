...
def remove_characters_make_lowercase(string):
    return string.replace(",", " ").replace(".", "").replace("/","").replace("-","").replace(":","").replace("∥", " ").replace("  ", " ").replace("'","").replace("!"," ").replace("\"","").lower()
...
print(string_preprocessing(example_string_2))
print(string_preprocessing(example_string_3))
print(string_preprocessing(example_string_4))
print(string_preprocessing(example_string_5))
